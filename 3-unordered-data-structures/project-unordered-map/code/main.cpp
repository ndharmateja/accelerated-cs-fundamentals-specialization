...
void wordcountTests()
{
    ...
    {
        std::cout << "Looks like makeWordCounts isn't implemented yet.\nSkipping lookupWithFallback tests based upon it." << std::endl
                  << std::endl;
        return;
    }
...
void lookupWithFallbackTests()
{
    ...
    std::cout << "======= Checking lookupWithFallback without dependencies =======" << std::endl
              << std::endl;
